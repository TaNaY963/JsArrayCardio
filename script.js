...
console.table('Born in 1500s:', fifteen);
...
console.log('Sorted by Birthdate:', ordered);
...
console.log('Sorted by Years Lived:', oldest);
...
console.log('Alphabetical Order:', alpha);

// 7. Count instances of items
const data = [
...
console.log('Transportation Count:', transportation);
